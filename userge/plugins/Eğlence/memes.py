...
async def hack_func(message):
    ...
    animation_chars = [
        ...
        "```Özel Sunucuya bağlanıyor /```",
        "```Bağlantı Kuruldu```",
        "```Hedef Belirlendi```",
        "``` Hedefte Backdoor Tespit edildi.```",
        "```Heck için Hazırlık sürüyor...```",
        "```Heykleniyor... %1\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒```",
        "```Heykleniyor... %4\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒```",
        "```Heykleniyor... %8\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒```",
        "```Heykleniyor... %20\n█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒```",
        ...
        "```Heykleniyor... %88\n█████████████████████▒```",
        "```Heykleniyor... %100\n███████████████████████```",
        "```Verileriniz Çalınıyor... %1\n▒██████████████████████```",
        "```Verileriniz Çalınıyor... %14\n████▒██████████████████```",
        "```Verileriniz Çalınıyor... %30\n████████▒██████████████```",
        "```Verileriniz Çalınıyor... %55\n████████████▒██████████```",
        "```Verileriniz Çalınıyor... %72\n████████████████▒██████```",
        "```Verileriniz Çalınıyor... %88\n████████████████████▒██```",
        "```Verileriniz Çalınıyor... %100\n███████████████████████```",
        "```Sunucuya veri yükleniyor... %12\n███▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒```",
        "```Sunucuya veri yükleniyor... %44\n█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒```",
        "```Sunucuya veri yükleniyor... %68\n███████████████▒▒▒▒▒▒▒▒```",
        "```Sunucuya veri yükleniyor... %89\n████████████████████▒▒▒```",
        "```Sunucuya veri yükleniyor... %100\n███████████████████████```",
        "**Veri Yükleme Tamamlandı:** Hedef Kullanıcının  Verileri tutuluyor "
        ": `downloads/hack/telegram-heyk.data.sql`",
    ]
    hecked = (f"**HEÇK - LEN - DİN !**\n\n```Heck'i kaldırmak için;``` {heckerman}``` "
              "30 ₿ BTC ödeyin ```")
